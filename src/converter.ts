/**
 * Converts the given navigation JSON into arrays of nodes and edges
 * compatible with React Flow / xyflow.
 *
 * @param {NavigationFile[]} json - The JSON array you provided (list of { file, routeDefs }).
 * @returns {{ nodes: AppNode[], edges: Edge[] }}
 */
